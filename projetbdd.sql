...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 30 Mars 2017 à 10:46
...
CREATE TABLE `inventeur` (
  ...
  `Numeros_de_permis` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `inventeur` (`ID_Inventeur`, `Nom_Inventeur`, `Numeros_de_permis`) VALUES
(1, 'Panoramix', 8034),
(2, 'Gandalf', 3965),
...
ALTER TABLE `est_constitue`
  ADD PRIMARY KEY (`ID_CmdClient`,`ID_Ingredient`,`ID_Onguent`,`ID_Potion`),
  ADD KEY `FK_est_constitue_ID_Ingredient` (`ID_Ingredient`),
...
--
ALTER TABLE `est_constitue`
  ADD CONSTRAINT `FK_est_constitue_ID_CmdClient` FOREIGN KEY (`ID_CmdClient`) REFERENCES `cmd_client` (`ID_CmdClient`),
